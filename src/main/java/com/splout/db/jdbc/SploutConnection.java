...
public class SploutConnection implements Connection {

  // The connection URL to a Splout SQL
  public String url;

  // A connection is tied to a particular tablespace
  public String tablespace;

  // The keys to be detected on queries.
  public String[] keys;

  public boolean closed = false;

  public SploutConnection(String url, String tablespace, String []keys) {
    this.url = url;
  ...
  public Statement createStatement() throws SQLException {
    return new SploutStatement(this);
  }
