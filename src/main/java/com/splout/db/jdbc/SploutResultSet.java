...
public class SploutResultSet implements ResultSet {

  private boolean isClosed = false;
  private final SploutStatement statement;
  ...
  public SploutResultSet(SploutStatement statement, QueryStatus status) {
    this.statement = statement;
    this.queryStatus = status;
    this.results = queryStatus.getResult();
  ...
  private void autodetectFields() {
    ...
    fields = results.get(0).keySet().toArray(new String[0]);
  }
  ...
  public Object getObject(int columnIndex) throws SQLException {
    return getObject(fields[columnIndex-1]);
  }
  ...
  public Object getObject(String columnLabel) throws SQLException {
    Object o = results.get(cursor).get(columnLabel);
    wasNull = o==null;
    return o;
  }
  ...
  public String getString(int columnIndex) throws SQLException {
    return getString(fields[columnIndex-1]);
  }
  ...
  public boolean getBoolean(int columnIndex) throws SQLException {
    return getBoolean(fields[columnIndex-1]);
  }
  ...
  public int getInt(int columnIndex) throws SQLException {
    return getInt(fields[columnIndex-1]);
  }
  ...
  public int getInt(String columnLabel) throws SQLException {
    ...
    throw new SQLException("Imposible to convert '" + o.getClass() + "' to 'Integer' for column '" + columnLabel + "'");
  }
  ...
  public long getLong(int columnIndex) throws SQLException {
    return getLong(fields[columnIndex]);
  }
  ...
  public long getLong(String columnLabel) throws SQLException {
    ...
    // No compatible conversion
    throw new SQLException("Imposible to convert '" + o.getClass() + "' to 'Long' for column '" + columnLabel + "'");
  }
  ...
  public float getFloat(int columnIndex) throws SQLException {
    return getFloat(fields[columnIndex-1]);
  }
  ...
  public float getFloat(String columnLabel) throws SQLException {
    ...
    if (o instanceof Float) {
      ...
      return new Float(getLong(columnLabel));
    } else if (o instanceof BigInteger) {
      return ((BigInteger) o).floatValue();
    }
    // No compatible conversion
    throw new SQLException("Imposible to convert '" + o.getClass() + "' to 'Float' for column '" + columnLabel + "'");
  }
  ...
  public double getDouble(int columnIndex) throws SQLException {
    return getDouble(fields[columnIndex-1]);
  }
  ...
  public double getDouble(String columnLabel) throws SQLException {
    ...
    if (o instanceof Double) {
      ...
      return new Double(getLong(columnLabel));
    } else if (o instanceof BigInteger) {
      return ((BigInteger) o).doubleValue();
    }
    // No compatible conversion
    throw new SQLException("Imposible to convert '" + o.getClass() + "' to 'Double' for column '" + columnLabel + "'");
  }
  ...
  public int findColumn(String columnLabel) throws SQLException {
    for (int i=0; i<fields.length; i++) {
      if (columnLabel.equals(fields[i])){
        return i + 1;
      }
    }
    throw new SQLException("Unexisting column '" + columnLabel + "'");
  }
